...
def model_provider():
    ...
    if args.hidden_size == 768:
        ...
        model_name = "GPT-350M"
    elif args.hidden_size == 1536:
        model_name = "GPT-760M"
    elif args.hidden_size == 2048:
        model_name = "GPT-1.3B"
    ...
    gpt_model = GPTModel(
        ...
        transformer_layer_spec=get_gpt_decoder_block_spec(transformer_config, use_transformer_engine=True, normalization=args.normalization), 
        vocab_size=51200, 
...
#######################################################################################
    if torch.distributed.get_rank() == 0: 
        ...
        output_dir = "/workspace/codes/fp16_profile_data/"+model_name

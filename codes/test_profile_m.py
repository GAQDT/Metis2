...
def model_provider(model_name):
    """Build the model."""
    model_specs = {
        "GPT-125M": {"num_layers": 12, "hidden_size": 768, "num_attention_heads": 12},
        "GPT-350M": {"num_layers": 24, "hidden_size": 1024, "num_attention_heads": 16},
        "GPT-760M": {"num_layers": 24, "hidden_size": 1536, "num_attention_heads": 16},
        "GPT-1.3B": {"num_layers": 24, "hidden_size": 2048, "num_attention_heads": 32}
    }
    ...
    performance_data["model"]["num_layers"] = specs["num_layers"]
...
if __name__ == "__main__":
    ...
    gpt_model = model_provider(model_name)
...
#######################################################################################
    if torch.distributed.get_rank() == 0: 
        ...
        output_dir = "../codes/profile_data/"+model_name
